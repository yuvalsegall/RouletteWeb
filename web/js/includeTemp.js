    ...
    for (var k = 0; k < numOfRows; k++) {
        ...
        for (var i = 0; i < numOfCols; i++) {
            ...
            if (i === 0)
                ...
                cell.addClass('midTd');
            row.append(cell);
            var button = getButtonByRow(k, buttonId, i);
            if(button === null)
                continue;
            else
                cell.append(button);
...
function getButtonByRow(k, buttonId, i){
    if (k === 0)
        return getButtonforFirstNumbersRow(buttonId, i);
    if (k === 1)
        return getButtonforSecondNumbersRow(buttonId, i);
    if (k === 2)
        return getButtonforThirdNumbersRow(buttonId, i);
    if (k === 3)
        return getButtonforMiddleNumbersRow(buttonId, i); 
    if (k === 4)
        return getButtonforFifthNumbersRow(buttonId, i);
    if (k === 5)
        return getButtonForSixthNumbersRow(buttonId, i);
}

function getButtonforFirstNumbersRow(buttonId, i){
    var firstNumber = 3;
...
function getButtonforSecondNumbersRow(buttonId, i){
    var firstNumber = 3;
...
function getButtonforThirdNumbersRow(buttonId, i){
    var firstNumber = 3;
...
function getButtonforFifthNumbersRow(buttonId, i){
    var firstNumber = 3;
...
function getButtonforMiddleNumbersRow(buttonId, i){
    var firstNumber = 3;
...
function getButtonForSixthNumbersRow(buttonId, i){
    var firstNumber = 3;
