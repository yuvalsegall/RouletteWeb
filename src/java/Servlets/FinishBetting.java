 ...
 * @author Yuval Segall
 */
@WebServlet(name = "FinishBetting", urlPatterns = {"/FinishBetting"})
public class FinishBetting extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            server.finishBetting(Integer.valueOf(request.getParameter("playerID")));
