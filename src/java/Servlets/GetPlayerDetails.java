 ...
 * @author Yuval Segall
 */
@WebServlet(name = "GetPlayerDetails", urlPatterns = {"/GetPlayerDetails"})
public class GetPlayerDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            PlayerDetails playerDetails = server.getPlayerDetails(Integer.valueOf(request.getParameter("playerID")));
            response.setContentType("application/json");
            Gson gson = new Gson();
            try (PrintWriter out = response.getWriter()) {
                out.println(gson.toJson(playerDetails));
            }
