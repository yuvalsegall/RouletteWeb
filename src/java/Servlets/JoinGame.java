...
public class JoinGame extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!Utils.isParamsOk(request, response, String.class, "gameName", "playerName")) {
            return;
        }
        try {
            int id = server.joinGame(request.getParameter("gameName"), request.getParameter("playerName"));
