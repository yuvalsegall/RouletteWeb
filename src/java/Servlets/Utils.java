...
public class Utils extends HttpServlet {
    ...
    public static Boolean isParamsOk(HttpServletRequest request, HttpServletResponse response, Class clas, String... params) {
        ...
        if (isAllGood && clas.equals(Integer.class)) {
            for (String param : params) {
                if (Integer.getInteger(request.getParameter(param)) == null) {
                    isAllGood = false;
                    break;
                }
            }
    ...
    public RouletteWebService gerServer(HttpServletResponse response) {
        RouletteWebService server;
        ...
        if (serverObj == null || !(serverObj instanceof RouletteWebService)) {
            ...
            server = (RouletteWebService) serverObj;
        }
        return server;
    }
}
