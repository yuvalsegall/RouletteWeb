...
public interface RouletteWebService {
     ...
     * @param eventId
     * @param playerId
     * @return returns java.util.List<ws.roulette.Event>
    ...
    public List<Event> getEvents(
            @WebParam(name = "eventId", targetNamespace = "") int eventId,
            @WebParam(name = "playerId", targetNamespace = "") int playerId)
            throws InvalidParameters_Exception;
    ...
    public void createGame(
            @WebParam(name = "computerizedPlayers", targetNamespace = "") int computerizedPlayers,
            @WebParam(name = "humanPlayers", targetNamespace = "") int humanPlayers,
            @WebParam(name = "initalSumOfMoney", targetNamespace = "") int initalSumOfMoney,
            @WebParam(name = "intMaxWages", targetNamespace = "") int intMaxWages,
            @WebParam(name = "minWages", targetNamespace = "") int minWages,
            @WebParam(name = "name", targetNamespace = "") String name,
            @WebParam(name = "rouletteType", targetNamespace = "") RouletteType rouletteType)
            throws DuplicateGameName_Exception, InvalidParameters_Exception;

    /**
     *
     * @param gameName
     * @return returns ws.roulette.GameDetails
    ...
    public GameDetails getGameDetails(
            @WebParam(name = "gameName", targetNamespace = "") String gameName)
            throws GameDoesNotExists_Exception;
    ...
    public int joinGame(
            @WebParam(name = "gameName", targetNamespace = "") String gameName,
            @WebParam(name = "playerName", targetNamespace = "") String playerName)
            throws GameDoesNotExists_Exception, InvalidParameters_Exception;

    /**
     *
     * @param playerId
     * @return returns ws.roulette.PlayerDetails
     * @throws GameDoesNotExists_Exception
     * @throws InvalidParameters_Exception
     */
    @WebMethod
    ...
    public void makeBet(
            @WebParam(name = "betMoney", targetNamespace = "") int betMoney,
            @WebParam(name = "betType", targetNamespace = "") BetType betType,
            @WebParam(name = "numbers", targetNamespace = "") List<Integer> numbers,
            @WebParam(name = "playerId", targetNamespace = "") int playerId)
            throws InvalidParameters_Exception;
    ...
    public String createGameFromXML(
            @WebParam(name = "xmlData", targetNamespace = "") String xmlData)
            throws DuplicateGameName_Exception, InvalidParameters_Exception, InvalidXML_Exception;

    /**
     *
     * @param gameName
     * @return returns java.util.List<ws.roulette.PlayerDetails>
     * @throws GameDoesNotExists_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
